...
NSString* ATPipelineTaskQueuedNotification = @"com.apptapp.installer.task.queued";
NSString* ATPipelineTaskFinishedNotification = @"com.apptapp.installer.task.finished";
NSString* ATPipelineTaskStatusNotification = @"com.apptapp.installer.task.status";
NSString* ATPipelineTaskProgressNotification = @"com.apptapp.installer.task.progress";
NSString* ATPipelineTaskChangedNotification = @"com.apptapp.installer.task.changed";
