...
@property (nonatomic, assign, getter=_get_str_category, setter=setCategory:) NSString * category;
...
@property (nonatomic, assign, getter=_get_dbl_myRating, setter=setMyRating:) NSNumber* myRating;
...
@property (readonly) BOOL hasScreenshots;

@property (assign) ATPackageSynchronizeStatus synchronizeStatus;
@property (retain) NSString* synchronizeVersion;

@property (assign, getter=_get_arr_screenshots, setter=_set_screenshots:) NSMutableArray* screenshots; // NB: An array of NSStrings, not NSURLs!
