...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (cell == nil)
	{
		cell = [[ATTaskTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
	}
...
{	
	...
	if ([self.tasks count])
        self.tabBarItem.badgeValue = [NSString stringWithFormat:@"%lu", (unsigned long)[self.tasks count]];
	else
