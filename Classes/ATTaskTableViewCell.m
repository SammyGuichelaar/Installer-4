...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        taskName.minimumScaleFactor = 13.;
		...
		CGSize sz = [[NSString stringWithString:NSLocalizedString(@"Status:", @"")] sizeWithAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:fontDescr.pointSize]}];
...
{
	return [NSString stringWithFormat:@"<ATTaskTableViewCell: 0x%@  title=%@ desc=%@ progress=%f>", self, taskName.text, taskDescription.text, progress.progress];
}
