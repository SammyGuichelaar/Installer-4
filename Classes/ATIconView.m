...
- (void)drawRect:(CGRect)rect {
	...
	if(icon == nil)
	{
		if (!gDefaultPackageIcon)
			gDefaultPackageIcon = [UIImage imageNamed:@"ATPack_Package.png"];
	...
	else
	{
		if (drawShadow)
		{
			...
			if (!gIconClippingMask)
				gIconClippingMask = [UIImage imageNamed:@"IconClipingMask.png"];
	...
	if(isTrusted)
	{
		if (!gIconTrustedImage)
			gIconTrustedImage = [UIImage imageNamed:@"ATTrustedicon.png"];
	...
	{
		if (!gIconNewImage)
			gIconNewImage = [UIImage imageNamed:@"ATNewIcon.png"];
	...
	{
		if (!gIconStopImage)
			gIconStopImage = [UIImage imageNamed:@"ATStopIcon.png"];
