...
- (void)taskStart
{
	...
	NSURL* sourceURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://search.i.apptapp.com/s/?q=%@&os=%@", [self.search stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]], [[ATPlatform firmwareVersion] stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]] ]];
