...
- (IBAction)mailButtonPressed:(id)sender
{
	if (package.contact)
	{
		NSURL* contact = [NSURL URLWithString:[NSString stringWithFormat:@"mailto:%@?subject=%@", package.contact, [[NSString stringWithFormat:@"Regarding package %@", package.name] stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]]]];
...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    CGRect textRect = [packageDescriptionLabel.text boundingRectWithSize:CGSizeMake(rTemp.size.width, 650)
                                         options:NSStringDrawingUsesLineFragmentOrigin
                                      attributes:@{NSFontAttributeName:packageDescriptionLabel.font}
                                         context:nil];
...
#pragma mark -
//Deprecated and seemingly unused function - commented out
